  ...
  module.directive('sticky', ['$window', '$timeout', function($window, $timeout) {
      return {
        ...
        link: function linkFn($scope, $elem, $attrs) {
           ...
           */
          function resetLayout(newWidth, newHeight) {

            var initialCSS = $scope.getInitialCSS(),
        ...
        controller: ['$scope', '$window', function($scope, $window) {
          ...
          /**
           * return a reference to reseting layout method
           */
          this.resetLayout = function(newWidth, newHeight) {
            return $scope.resetLayout(newWidth, newHeight);
          };
